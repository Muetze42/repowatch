...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/norman/Workplace/skeletons/laravel-starter-kit/laravel-starter-kit/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/norman/Workplace/skeletons/laravel-starter-kit/laravel-starter-kit/public/storage','logging.default','logging.deprecations.channel',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','cors.paths',
...
'broadcasting.connections.log.driver','broadcasting.connections.null.driver','inertia.ssr.enabled','inertia.ssr.url','inertia.testing.ensure_pages_exist',
...
'web','api',);
        registerArgumentsSet('routes', 'api.','storage.local',);
