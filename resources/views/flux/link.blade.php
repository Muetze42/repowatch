...
$classes = Flux::classes()
    ->add('font-medium')
    ->add($external ? 'inline-flex -items-center' : 'inline')
...
<a {{ $attributes->class($classes) }} data-flux-link <?php if ($external) : ?>target="_blank"<?php endif; ?>>
  {{ $slot }}
  @if ($external)
    <flux:icon.external-link class="size-4" />
  @endif
</a>
